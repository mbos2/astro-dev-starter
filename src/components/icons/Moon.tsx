...
const Moon = ({id, className, onClick}: SharedProps) => {
  return (
    <svg className={className} id={id} onClick={onClick} xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 120 120" fill="none">
